import "./Section2.css"
import Balde from "../images/balde_troca.png"
import Folha from "../images/folha_co.png"
import Money from "../images/dinheiro_aluno.png"
    ...
    return(
        <section className="Section2">
            ...
            <main className="co2-evitado">
                <img src={Folha} alt="" className="Folha"/>
